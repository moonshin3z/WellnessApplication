...
-- 2) Tabla de recursos (con TODO lo que usas)
CREATE TABLE IF NOT EXISTS resources (
  ...
  created_by          BIGINT,                                    -- legacy usado por tu código
...
-- 3) Archivos asociados a recursos (V4 original)
...
-- 5) Índices útiles (incluye los legacy que te fallaban)
